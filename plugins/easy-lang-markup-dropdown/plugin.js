...
/*
 * @file easy-lang-markup-dropdown/plugin.js
 * @description TinyMCE plug-in which provides controls for marking up the human language of text passages.
 * @author Brian Richwine <brichwin@iu.edu>
 * @copyright Copyright (c) 2018 The Trustees of Indiana University
